...
public abstract class AbstractPipeLinkTest<LINK_T extends PipeLink<Object>> {
    ...
    public void demonstrateFetchTimeoutWithSuccessfulGet() {
        ...
        final Object monkeyOut = fixture.get();
        assertNotNull("Got a null item out", monkeyOut);
        assertSame("Got the same test item out", monkey, monkeyOut);
    }
    ...
    public void demonstrateQueueLengthRemainingCapacityAndClear() {
        ...
        assertEquals("Empty fixture does not have capacity equal to capacity", this.getMaxCapacity(), fixture
        ...
        assertEquals("Fixture does not have capacity equal to capacity after clear", this.getMaxCapacity(), fixture
                .getRemainingCapacity());
    ...
    protected Producer<Object> tokenProducer(final LINK_T fixture) {
        ...
        return new CollectionProducer<Object>(
                Arrays.asList(new Object[] { new Object() }),
                new ExceptionThreadingModel(),
                link) {
            @Override
    ...
    public void validateCreateFixture() {
        ...
        assertNotSame("Created the same fixture twice", this.createFixture(), this.createFixture());
        assertTrue("Fixture is created with a source", this.createFixture().sources.isEmpty());
    }
